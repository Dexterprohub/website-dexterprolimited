...
const ServicePage = () => {
    ...
    const [newState, newSetState] = useState(false);
        ...
        <div className={`${styles.paddingX}  ${styles.flexStart} `}>
            <div className={` ${styles.boxWidth}`}>
                ...
                <div className="flex flex-col my-[30px]  md:flex-row   items-start gap-[8px] font-monseratt font-semibold tabs" >
                    ...
                    <div className={`${state === 1 ? "colored active-tab" : "tab"} flex flex-row gap-[10px] cursor-pointer  w-full p-[10px] items-center border-t-[2px] greyscale`}
                        onClick={()=>action(1)}>
                    ...
                    <div className={`${state === 2 ? "colored active-tab" : "tab"} flex flex-row gap-[10px]  w-full p-[10px]  items-center border-t-[2px] cursor-pointer greyscale`}
                        onClick={()=>action(2)} >
                    ...
                    <div className={`${state === 3 ? "colored active-tab" : "tab"} flex flex-row gap-[10px]  w-full p-[8px] items-center border-t-[2px] cursor-pointer greyscale `}
                        onClick={()=>action(3)}>
                ...
                <div className="flex flex-col font-thiccboi gap-[24px] text-[16px] leading-[30px] inner-tabs mb-[50px] font-thiccboi ">
                    ...
                    {/* Surface */}
                    <div className={` ${state === 1 ? "inner-tab-active" : "inner-tab"} rounded-[20px]  `}>
                        ...
                        <div className={` ${ newState ? "active-tab" : "" }   bx-shadow p-[10px] sm:p-[16px] items-center gap-[10px] `}   onClick={ () => newSetState((prev) => !prev) } >
                            ...
                            <div className={`dropdown-tab px-[40px] ${newState  ? "dropdown-tab-active" : "dropdown-tab"} `}>
                                <p className="pl-[10px]  lg:px-[50px]">
                    ...
                    <div className={` ${state === 1 ? "inner-tab-active" : "inner-tab"}  p-[10px] sm:p-[16px] bx-shadow`}>
                        ...
                        <div className={` ${newState === 2 ? "dropdown-tab-active" : "tab"}  items-start gap-[10px] cursor-pointer `}   onClick={ () => newAction(2) } >
                    ...
                    <div className={` ${state === 1 ? "inner-tab-active" : "inner-tab"} p-[10px] sm:p-[16px] bx-shadow `}>
                        ...
                        <div className={` ${newState === 3 ? "dropdown-tab-active" : "tab"}   items-start gap-[10px] cursor-pointer `}   onClick={ () => newAction(3) } >
                    ...
                    <div className={` ${state === 1 ? "inner-tab-active" : "inner-tab"} p-[10px] sm:p-[16px] bx-shadow `}>
                        ...
                        <div className={` ${newState === 4 ? "dropdown-tab-active" : "dropdown-tab-active"} cursor-pointer p-[10px] items-start gap-[10px] `}   onClick={ () => newAction(4) } >

                            <div className="flex flex-row  gap-[10px] cursor-pointer mb-[20px]">
                    ...
                    <div className={` ${state === 1 ? "inner-tab-active" : "inner-tab"} p-[10px] sm:p-[16px] bx-shadow `}>
                        ...
                        <div className={` ${newState === 5 ? "dropdown-tab-active" : "dropdown-tab-active"}  p-[10px] items-center justify-start gap-[10px]  `}   onClick={ () => newAction(5) } >
                            ...
                            <div className="flex flex-row  gap-[10px] cursor-pointer mb-[20px]">
                                ...
                                />
                                {/* onClick={() => setToggle((prev) => (!prev && newAction(0)))} */}
                    ...
                    <div className={` ${state === 1 ? "inner-tab-active" : "inner-tab"} p-[10px] sm:p-[16px] bx-shadow `}>
                        ...
                        <div className={` ${newState === 6 ? "dropdown-tab-active" : "dropdown-tab-active"}  p-[10px] items-start gap-[10px] `}   onClick={ () => newAction(6) } >
                            ...
                            <div className="flex flex-row  gap-[10px] cursor-pointer mb-[20px] ">
                                ...
                                />
                                <h1 className="text-shadeGrey font-bold lg:text-[22px]">Asset Acquisition & Advisory</h1>
                            </div>

                            <div className={`dropdown-tab px-[40px] ${newState === 6 ? "dropdown-tab-active" : "dropdown-tab"}`}>
                                <p className="pl-[10px]">
                    ...
                    {/* <div className={`  p-[10px] sm:p-[16px] bx-shadow `}>
                        
                        <div className={` ${newState === 7 ? "dropdown-tab-active" : "dropdown-tab-active"}  p-[10px] items-start gap-[10px] cursor-pointer `}   onClick={ () => newAction(7) } >

                            <div className="flex flex-row  gap-[10px] cursor-pointer mb-[20px]">
                                <img src={newState === 7 ? minusBox : addBox} 
                                    alt="expand"  
                                    className="w-[30px] h-[30px] object-contain" 
                                    
                                />
                                <h1 className="text-shadeGrey font-bold lg:text-[22px]">Investor Relation Management</h1>
                            </div>

                            {/* <div className={`dropdown-tab px-[40px]  ${newState === 7 ? "dropdown-tab-active" : "dropdown-tab"}`}>
                                <p>
                                We have developed the most comprehensive set of proprietary tools to assist in the evaluation of the information contained in most data rooms.  Our experience and skills helps us to quickly identify and evaluate the key risk areas and identify valuation  issues to help ensure your acquisition success
                                </p>
                                <br />
                                ...
                                <p> 
                                    <h2 className="font-bold my-[10px] text-[18px]">Asset Management Capabilities Include: </h2>
                                    <ul className="pl-[20px]">
                                        <li>● Monthly review of each assets performance that includes senior management asset management and property management teams

                                        </li>
                                        <li>● Quarterly hold/sell/re-position analysis</li>
                                        <li>● Continuous market and sub-market research and analysis</li>
                                        <li>● Development and implementation of value-add and re-position plans</li>
                                        <li>● In-house construction management and general contracting capabilities</li>
                                        
                                    </ul>

                                    <h2 className="font-bold my-[10px] text-[18px]">Our advisory capabilities include: </h2>

                                    <ul className="pl-[20px]">
                                        <li>● Debt/Equity recapitalization and advisory services</li>
                                        <li>● Receivership, Trustee & Monitoring Services </li>
                                        <li>● Investor/Asset Due Diligence </li>
                                        <li>● Redevelopment/Repositioning</li>
                                        <li>● Valuation Analysis & Financial Modeling</li>
                                        <li>● Note Sales and Workouts</li>
                                    </ul>
                    ...
                    <div className={` ${state === 2 ? "inner-tab-active" : "inner-tab" } font-thiccboi  p-[10px] sm:p-[16px] `}>
                        ...
                        <div className="flex flex-col gap-[24px] font-thiccboi text-[16px] leading-[30px]">
                            ...
                            {/* Marine Engineering */}
                            <div className={` ${newState === 2 ? "tab active-tab" : "tab"}  items-start bx-shadow  p-[10px] sm:p-[16px]`}   onClick={ () => newAction(2) } >
                    ...
                    <div className={` ${state === 3 ? "inner-tab-active" : "inner-tab"}`}>
                        ...
                        <div className="flex flex-col gap-[24px] font-thiccboi text-[16px] leading-[30px]">
                            ...
                            {/* Dexter Hub */}
                            <div className={` ${newState === 4 ? "tab active-tab" : "tab"}  p-[10px] sm:p-[16px] bx-shadow items-center justify-start gap-[10px] `}   onClick={ () => newAction(4) } >

                                <div className="flex flex-row p-[10px] gap-[10px] cursor-pointer ">
                                    <img src={newState === 4 ? minusBox : addBox} className=" w-[30px] h-[30px] " />
